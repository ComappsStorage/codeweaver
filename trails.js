var BuiltinModule = require('node:module')
...
function addAliases (aliases) {
  aliases = {'@vendors': __dirname + '/vendors/@application', '@polka': __dirname + '/vendors/@polka', '@sirv': __dirname + '/vendors/@sirv', '@tempura': __dirname + '/vendors/@tempura', '@locate': __dirname + '/vendors/@locate', '@identifiers': __dirname + '/vendors/@identifiers', '@strings': __dirname + '/vendors/@strings', '@regex': __dirname + '/vendors/@regex', '@orientations': __dirname + '/orientations'}
...
module.exports.config = addAliases
